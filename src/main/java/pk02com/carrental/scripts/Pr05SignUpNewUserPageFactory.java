...
import pk02.com.carrental.pages.RegisterLoginPageFactory;

public class Pr05SignUpNewUserPageFactory {
	...
	public static void main(String[] args) {
		...
		RegisterLoginPageFactory registerLoginPage = new RegisterLoginPageFactory(driver);
