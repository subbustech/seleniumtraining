...
public class Pr01VerifyPages {
	...
	public void verifyHomePage() {
		...
		StoreDrivers.map1.put("pk12testnglistenerstakescreenshot.Pr01VerifyPages", driver);
		
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

		driver.get("http://localhost/carrental");
		
		boolean header1 = driver.findElement(By.xpath("//h21[contains(text(),'Find the Best') and span[contains(text(),'CarForYou')]]")).isDisplayed();
